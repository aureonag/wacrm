...
Depois de investigar, registre na coluna "Observações / sinais encontrados" quais desses sinais você encontrou (positivos e negativos) — por exemplo: "Google 4.7 (32 avaliações), Instagram ativo mas sem oferta clara, site não é responsivo, fácil pedir orçamento pelo WhatsApp".
...
Depois de investigar, registre na coluna "Observações / sinais encontrados" quais desses sinais você encontrou (positivos e negativos) — por exemplo: "Loja ativa com +50 produtos e avaliações reais, Instagram só posta produto sem oferta, nenhum sinal de recuperação de carrinho".
